...
public class PlaceOnPlaneNewInputSystem : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        controls = new NewInputAction();
        // If there is existing touch input, change the isPressed to true.
        // If the touch input is stopped, change the isPressed to false.
        controls.SpawnObject.TapPress.performed += _ => isPressed = true;
        controls.SpawnObject.TapPress.canceled += _ => isPressed = false;
    }
    ...
    {
        controls.SpawnObject.Enable();
    }

    private void OnDisable()
    {
        controls.SpawnObject.Disable();
    }
}
